...
![image-20250304112130582](./Convolution.assets/image-20250304112130582.png)
...
![image-20250304200418339](./Convolution.assets/image-20250304200418339.png)

### 6.2 代码实现

只需要实例化一个`Sequential`块并将需要的层连接在一起：
